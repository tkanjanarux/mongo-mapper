...
// same endpoint.
handlerFactories.auto = function (options, mapperConfig, configIn) {
  ...
  var factoryFunction = function (configIn) {
 ...
 */
exports.makeMapper = function (dbConnection, configIn) {
  var service = {};
  ...
  ['get', 'post', 'put', 'delete', 'auto'].forEach(function (method) {
    service[method] = function (arg) {
      ...
      return handlerFactory(options, configIn);
    };
  });
